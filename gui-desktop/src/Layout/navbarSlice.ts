...
import { LoginNavbarObj } from "./navItems";
...
const initialState: NavbarState = {
  isCollapsed: true,
  items: [
    { placeholder: "OGGLabs", navigateTo: "/about" },
    { placeholder: "Home", navigateTo: "/" },
    LoginNavbarObj,
    { placeholder: "Sign Up", navigateTo: "/sign-up" },
    LibraryNavbarObj,
  ],
};
...
const navbarSlice = createSlice({
  ...
  reducers: {
    ...
    centerNavbarTitle: (
      state,
      action: {
        payload: { placeholder: string; navigateTo: string };
        type: string;
      }
    ) => {
