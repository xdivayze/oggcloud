...
import SignUp, { SignUpErrorMessageTestID, SignUpSubmitBtnTestID } from "./SignUp";
import { fireEvent, render, screen, waitFor } from "@testing-library/react";
import { SignUpPasswordRepeatTestID, SignUpEMailSpanTestID, SignUpPasswdSpanTestID } from "./components/InputBase";
...
describe("sign up page", () => { //TODO fire verify click, enter verification code, then submit
  beforeEach(() => {
    vi.clearAllMocks();
  });
  it("updates authentication state through reducer", async () => {
    ...
    fireEvent.input(passwordRepeatSpan, {target: {textContent: examplePassword}});
